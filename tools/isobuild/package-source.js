...
_.extend(PackageSource.prototype, {
        ...
        getFiles(sourceProcessorSet, watchSet) {
          ...
          self._findSources({
            ...
            if (! _.has(relPathToSourceObj, relPath)) {
              const fileOptions = self._inferFileOptions(relPath, arch);
        ...
        getFiles(sourceProcessorSet, watchSet) {
          ...
          return {
            sources: self._findSources(findOptions).sort(
              ...
              return {
                relPath,
                fileOptions: self._inferFileOptions(relPath, arch),
              };
            }),
  ...
  _inferFileOptions(relPath, arch) {
    const fileOptions = {};

    if (relPath.match(/\bnode_modules\//)) {
      fileOptions.lazy = true;
